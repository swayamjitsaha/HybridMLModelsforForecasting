...
# selecting only the Wind Speed values
dhiValues = dataset[:,[9]]
...
model.add(LSTM(10, stateful=True))   # 2nd layer of the network
...
plt.title('Hour Vs Wind Speed for Starkville Airport(Jan 2020) - Stacked Stateful LSTM')
plt.xlabel('Hour')
